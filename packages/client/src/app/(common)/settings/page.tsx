  ...
  return (
    <div className={settingsStyles.settingsContainer}>
      <PageTitle
        ...
        subtitleContent="modify your account details"
      />
      <SettingsContent />
    </div>
  );
...
const AccountSettings = () => {
  ...
  const handleOnAccountSettingsSubmit = (e: React.SyntheticEvent) => {
    ...
    if (templateProfile.password !== verifiedPassword) {
      ...
      dispatch(updateUser(templateProfile));
    }
  };

  return (
    <section className={settingsStyles.accountSettingsContainer}>
      <PopupModal hasBorder={false} modalType="form" />
      <h2>Account Settings</h2>
      <form className={settingsStyles.accountSettingsForm}>
        <TextFormControl
          direction="column"
          labelColor="#DDD9D5"
          type="text"
