// NOTE: In the documentation for OneSignal it says to use importScripts
// NOTE: That does not work properly so i just copied the script content as a workaround
